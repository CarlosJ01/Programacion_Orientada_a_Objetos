package clase_juego_ver03;
import java.io.IOException;
import java.util.Random;
import java.util.Scanner;
public class Clase_Juego_Ver03 {
    ...
    public static int[] rondas(int[] ind,Juego jugadores[],int inicio,int fin,String juego) throws IOException{
        ...
        if (pausa==false)
            jugadores[ind[1]].mostrar_ganador(ind[1],jugadores,inicio,fin);
        return ind;
    }
    ////////////////////////Invitar a Jugar/////////////////////////////////////
...
interface Juego{
    ////////////////////////////Lanzar Dados////////////////////////////////////
    void lanzar(int numDad);
    /////////////////////////////Mostrar el estado del Jugador//////////////////
    void mostrar_edo();
    /////////////////////////Mostrar al Ganador/////////////////////////////////
    void mostrar_ganador(int g,Juego[] jugadores,int inicio, int fin);
    //Metodos solo para sobrescribir
    Juego jugar();
    Juego SeguirReglas(Juego[] jugadores,int j,int inicio);
    boolean ganar();
}

/////////////////////////////Clase SerpyEsc/////////////////////////////////////
class SerpyEsc implements Juego{
    static int esc1=5,esc2=30,serp1=45,serp2=20;
    static boolean ganador=false;
    String nomJug = "";
    String nomCas = "";
    int casAct=0,casAnt=0,puntos=0,numDad=0,numCas=0;
    SerpyEsc(String nom) {
        nomJug=nom;
        numCas=60;
        casAct=0;
    ...
    /////////////////////////Mostrar al Ganador/////////////////////////////////
    @Override
    public void mostrar_ganador(int g,Juego[] jugadores,int inicio, int fin){
        int i;
        System.out.println("=============================== FELIZIDADES GANASTES "+" ===============================");
